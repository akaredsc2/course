...
public class CeremonySwitchServlet extends HttpServlet {
    ...
    private void retrieveRestaurants(HttpServletRequest req, Connection connection) throws SQLException {
    ...
    private void retrieveArtists(HttpServletRequest req, Connection connection) throws SQLException {
